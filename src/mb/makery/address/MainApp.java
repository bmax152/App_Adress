...
public class MainApp extends Application {
	...
	//Permet de récuperer le stage et le rootLayout (de la première vue)
    ...
    public void start(Stage primaryStage) {
        ...
        //Permet de créer la fenêtre qui va englober la vue
        initRootLayout();
        //Ajoute la seconde vue au centre de la première
        showPersonOverview();
    }
    ...
    public void showPersonOverview() {
        try {
            ...
            // Attache la seconde vue au cenrtre de la première 
            rootLayout.setCenter(personOverview);
            
            //Accés aux controlleur
